...
const AddCommentForm = ({ articleName, setArticleInfo}) => {
  ...
  return (
    <form className='shadow rounded px-8 pt-6 pb-8 mb-4'>
        ...
        <textarea rows='4' cols='50' onChange={(e) => setCommentText(e.target.value)} value={commentText} className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' />
